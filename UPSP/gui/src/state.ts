...
export const runtimeProjection: RuntimeProjection = {
  ...
  detailGeneration: 0,
  legacyCards: new Map(),
  legacyCardsLoading: new Set(),
  legacyCardsErrors: new Map(),
  ledgerItems: new Map(),
  ledgerItemsLoading: new Set(),
  ledgerItemsErrors: new Map(),
  frameDetail: null,
  frameDetailLoading: "",
  frameDetailError: "",
  timelineNodeDetails: new Map(),
  timelineNodeLoading: new Set(),
  timelineNodeErrors: new Map(),
...
export const els: Elements = {
  ...
  mainStage: requiredElement<HTMLElement>("#mainStage"),
  stagePage: requiredElement<HTMLElement>("#stagePage"),
  systemWindowSplitter: requiredElement<HTMLElement>("#systemWindowSplitter"),
