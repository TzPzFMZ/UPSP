...
TOOL_DEFINITIONS = {
    ...
    "memory_recall_complete": {
        ...
        "domain": "memory",
        "risk": "high",
        "handler": "memory_recall_completion_processor",
        "result_kind": "protocol_tool_receipt",
    },
    "memory_content_read": {
        "tool_family": "protocol_tool",
    ...
    "pending_cancel": {
        "tool_family": "protocol_tool",
        "tool_class": "sync_tool",
        "domain": "write_settlement",
        "risk": "medium",
        "handler": "write_pending_settlement_processor",
        "result_kind": "protocol_tool_receipt",
    },
    "relay_intent_settle": {
        "tool_family": "protocol_tool",
    ...
    "cache_compact": {
        ...
        "domain": "context",
        "risk": "high",
        "handler": "cache_compact_executor",
        "result_kind": "lately_cache_rewrite",
    },
    "heartbeat_tick": {
        "tool_family": "substrate_tool",
        "tool_class": "sync_tool",
...
SUBMISSION_ALIASES = {
    ...
    "memory_recall_completion_request": "memory_recall_complete",
