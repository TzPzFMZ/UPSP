...
1. Download `UPSP-Setup-0.1.0-alpha.6-win-x64.exe` from [GitHub Releases](https://github.com/TzPzFMZ/UPSP/releases).
...
See the [Alpha 6 Release Notes](docs/public/releases/0.1.0-alpha.6.md) for the full change list, upgrade boundaries, and known limitations.
